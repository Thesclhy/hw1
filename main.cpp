...
void initialise()
{
    ...
    //g_model_matrix = glm::translate(g_model_matrix, glm::vec3(0.001f, 0.0f, 0.0f));
...
void update() { 
    //g_model_matrix = glm::translate(g_model_matrix, glm::vec3(0.001f, 0.0f, 0.0f));
    //g_model_matrix = glm::rotate(g_model_matrix, 0.001f, glm::vec3(0.0f, 1.0f, 0.0f));
    //g_model_matrix = glm::scale(g_model_matrix, glm::vec3(1.0001f, 1.0001f, 0.0f));
}
